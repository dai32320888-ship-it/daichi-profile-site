...
function productIntro(product) {
  return product.intro || product.description;
}

function productCaution(product) {
  return product.caution || "サイズ、設置場所、レビューの低評価理由は楽天の商品ページで確認してから選んでください。";
}
  ...
  <body>
    <header class="site-header">
      ...
      <nav class="site-nav" aria-label="メインナビゲーション">
        ...
        <a href="../../index.html#/category/car">車内収納</a>
      </nav>
    </header>
    <main>${body}</main>
